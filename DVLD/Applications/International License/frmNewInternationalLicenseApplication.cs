...
namespace DVLD.Applications.International_License
{
    public partial class frmNewInternationalLicenseApplication : Form
    {
        ...
        private void ctrlDriverLicenseInfoWithFilter1_OnLicenseSelected(int obj)
        {
           ...
           int ActiveInternaionalLicenseID = clsInternationalLicense.GetActiveInternationalLicenseIDByDriverID
        ...
        private void lbl_ILAPPID_Click(object sender, EventArgs e)
        {

        }

        private void lbl_ILLID_Click(object sender, EventArgs e)
        {

        }

        private void lblExpirtionDate_Click(object sender, EventArgs e)
        {
