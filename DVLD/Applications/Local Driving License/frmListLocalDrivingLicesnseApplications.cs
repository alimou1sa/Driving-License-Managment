...
namespace DVLD.Tests
{
    public partial class frmListLocalDrivingLicesnseApplications : Form
    {
        ...
        private void _RefressLocalDrivingLicesnseList()
        {
        ...
        private void showDetailsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            frm.ShowDialog();
            _RefressLocalDrivingLicesnseList();
        ...
        private void vistionTestToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            clsTestAppointment Appointment =clsTestAppointment.GetLastTestAppointment
                (LocalDrivingLicenseApplicationID, clsTestType.enTestType.VisionTest);
