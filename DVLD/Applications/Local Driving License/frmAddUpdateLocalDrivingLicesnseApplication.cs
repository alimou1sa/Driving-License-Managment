...
namespace DVLD.Applications
{
    ...
    public partial class frmAddUpdateLocalDrivingLicesnseApplication: Form
    {
        ...
        private void _LoadData()
        {
            ...
            cbLicenseClass.SelectedIndex = cbLicenseClass.FindString(clsLicenseClass.Find
        ...
        private void btnSave_Click_1(object sender, EventArgs e)
        {
            ...
            if (ActiveApplicationID != -1)
            {
                MessageBox.Show("Choose another License Class, the selected Person Already have an active " +
                    "application for the selected class with id=" + ActiveApplicationID, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
