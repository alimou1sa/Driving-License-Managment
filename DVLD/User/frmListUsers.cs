...
namespace DVLD.User
{
    public partial class frmListUsers : Form
    {
        ...
        private void editToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            frmAddUpdateUser Frm1 = new frmAddUpdateUser((int)dgvListUsers.CurrentRow.Cells[0].Value);
            Frm1.ShowDialog();
        ...
        {
            frmUserInfo Frm1 = new frmUserInfo((int)dgvListUsers.CurrentRow.Cells[0].Value);
            Frm1.ShowDialog();
